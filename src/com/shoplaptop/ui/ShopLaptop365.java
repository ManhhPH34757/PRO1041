...
public class ShopLaptop365 extends JFrame {
	...
	public ShopLaptop365() {
		...
		btnKetThuc.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		...
		btnDonHang.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		...
		btnHoaDon.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		...
		btnLaptop.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		...
		btnPhieuGiamGia.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		...
		btnDotGiamGia.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		...
		btnPhieuDoi.setFont(new Font("Times New Roman", Font.PLAIN, 18));
